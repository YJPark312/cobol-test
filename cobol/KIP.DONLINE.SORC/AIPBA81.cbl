      *=================================================================
      *@업무명    : KIP     (기업집단신용평가)
      *@프로그램명: AIPBA81 (AS기업집단신용등급조정검토등록)
      *@처리유형  : AS
      *@처리개요  : 기업집단신용등급조정검토등록하는 프로그램이다
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIPBA81'.
      ...
      *@3 처리DC호출: 재무평점일괄산출등록
           PERFORM S3100-PROC-DIPA811-RTN
              THRU S3100-PROC-DIPA811-EXT
      ...
      *@처리내용 : 처리DC입력파라미터 = AS입력파라미터
           ...
           MOVE  YNIPBA81-CA    TO  XDIPA811-IN
