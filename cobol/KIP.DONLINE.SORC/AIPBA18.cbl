      *=================================================================
      *@업무명    : KIP     (기업집단신용평가)
      *@프로그램명: AIPBA18 (AS관계기업군재무생성계열기업관리)
      *@처리유형  : AS
      *@처리개요  :관계기업군 재무생성계열기업을 관리하는 프로그램이다
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIPBA18'.
      ...
      *@   DC호출
      *@   입력 및 출력영역 초기화
           INITIALIZE XDIPA181-IN

      *@   DC입력파라미터 = AS입력파라미터
           MOVE YNIPBA18-CA
             TO XDIPA181-IN.

      *@   DC관계기업군재무생성계열기업관리 호출
           #DYCALL  DIPA181 YCCOMMON-CA XDIPA181-CA

      *@   SQLIO 호출결과 확인
           IF NOT COND-XDIPA181-OK       AND
              NOT COND-XDIPA181-NOTFOUND
              #ERROR XDIPA181-R-ERRCD
                     XDIPA181-R-TREAT-CD
                     XDIPA181-R-STAT
           END-IF.
      ...
      *@   처리내용 : 처리DC출력파라미터 = AS출력파라미터
           ...
           #USRLOG "★[대상여부1]=" YPIPBA18-VALUA-TAGET-YN1(1)
           #USRLOG "★[대상여부2]=" YPIPBA18-VALUA-TAGET-YN2(1)
           #USRLOG "★[대상여부3]=" YPIPBA18-VALUA-TAGET-YN3(1)
