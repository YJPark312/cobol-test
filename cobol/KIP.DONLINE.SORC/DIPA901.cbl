      ...
      *=================================================================
      *@업무명    : KIP     (기업집단신용평가)
      *@프로그램명: DIPA901 (DC기업집단종합의견조회)
      *@처리유형  : DC
      *@처리개요  : 기업집단종합의견을 조회하는 프로그램
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'DIPA901'.
      ...
      *  기업집단그룹코드
           MOVE  XDIPA901-I-CORP-CLCT-GROUP-CD
             TO  KIPB130-PK-CORP-CLCT-GROUP-CD

      *  기업집단등록코드
           MOVE  XDIPA901-I-CORP-CLCT-REGI-CD
             TO  KIPB130-PK-CORP-CLCT-REGI-CD

      *  평가년월일
           MOVE  XDIPA901-I-VALUA-YMD
             TO  KIPB130-PK-VALUA-YMD

      *  기업집단주석구분
           MOVE  XDIPA901-I-CORP-C-COMT-DSTCD
             TO  KIPB130-PK-CORP-C-COMT-DSTCD

      *  일련번호
           MOVE  XDIPA901-I-SERNO
             TO  KIPB130-PK-SERNO
