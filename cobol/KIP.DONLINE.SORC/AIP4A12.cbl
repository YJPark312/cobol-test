      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIP4A12'.
      ...
      *@1 관계기업군별관계사현황조회
           PERFORM S3100-CALL-DIPA121-RTN
              THRU S3100-CALL-DIPA121-EXT
      ...
      *------------------------------------------------------------------
       S3100-INPUT-SET-RTN.
      *
           INITIALIZE                  XDIPA121-IN
                                       YPIP4A12-CA

      *@1 입력파라미터 조립
           MOVE  YNIP4A12-CA  TO  XDIPA121-IN
           .
       S3100-INPUT-SET-EXT.
           EXIT.
      ...
      *@ 심사승인 진행대상 조회
      *------------------------------------------------------------------
       S3100-CALL-DIPA121-RTN.
      *@1 프로그램 호출
      *@처리내용 : DC관계기업군별관계사현황조회
      *@프로그램 호출
           #DYCALL  DIPA121 YCCOMMON-CA XDIPA121-CA

      *@1 호출결과 확인
           IF  NOT COND-XDIPA121-OK
               #ERROR   XDIPA121-R-ERRCD
                        XDIPA121-R-TREAT-CD
                        XDIPA121-R-STAT
           END-IF
           .
       S3100-CALL-DIPA121-EXT.
           EXIT.
