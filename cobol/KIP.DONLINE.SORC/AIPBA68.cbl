      *=================================================================
      *@업무명    : KIP     (기업집단신용평가)
      *@프로그램명: AIPBA68 (AS기업집단재무분석저장)
      *@처리유형  : AS
      *@처리개요  :기업집단재무분석평가를 저장하는 프로그램이다
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIPBA68'.
      ...
      *#  에러처리한다.
           IF NOT COND-XDIPA681-OK
              #ERROR XDIPA681-R-ERRCD
                     XDIPA681-R-TREAT-CD
                     XDIPA681-R-STAT
           END-IF.
