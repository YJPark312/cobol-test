      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIP4ZOS'.
      ...
      *@1 출력영역확보 파라미터 및 결과코드 초기화
           ...
           #USRLOG "■■YNIP4ZOS-CA: " YNIP4ZOS-CA
      ...
      *#  입력항목검증
      *@   프로그램명
           IF YNIP4ZOS-PGM-NAME = SPACE  THEN
      *       프로그램명 오류입니다.
      *       처리구분코드를 입력해 주십시오.
      ...
      *@   입력데이터
           IF YNIP4ZOS-INPT-DATA     = SPACE        AND
              YNIP4ZOS-PGM-NAME  NOT = 'IJD0005'    THEN
      *       입력데이터 오류입니다.
      ...
      *@   처리구분
      *    IF YNIP4ZOS-PRCSS-DSTCD = SPACE  THEN
      *       처리구분코드 오류입니다.
      *       처리구분코드를 입력해 주십시오.
      ...
      *
      *#   심사고객식별자
      *    IF YNIP4ZOS-EXMTN-CUST-IDNFR = SPACE  THEN
      *       심사고객식별자 오류입니다.
      *       심사고객식별자를 입력해 주십시오.
      ...
      *
      *#   기업집단그룹코드
      *    IF YNIP4ZOS-CORP-CLCT-GROUP-CD = SPACE  THEN
      *       필수항목 오류입니다.
      ...
      *
      *#   기업집단등록코드
      *    IF YNIP4ZOS-CORP-CLCT-REGI-CD = SPACE  THEN
      *       필수항목 오류입니다.
      ...
      *-----------------------------------------------------------------
       S3000-PROCESS-RTN.
      *    프로그램명
           MOVE YNIP4ZOS-PGM-NAME
             TO YPIP4ZOS-PGM-NAME

      *#   프로그램명 분기처리
           EVALUATE YNIP4ZOS-PGM-NAME
           WHEN 'IIPEAI0'
      *@        IC관계기업군현황갱신 연계조회
      ...
      *    END-EVALUATE.
           MOVE 'V1'           TO WK-FMID(1:2)
           MOVE 'KIP04ZOS000'  TO WK-FMID(3:11)

           #USRLOG "■■YPIP4ZOS-CA: " YPIP4ZOS-CA

           #BOFMID 'V7KIP04ZOS000'
