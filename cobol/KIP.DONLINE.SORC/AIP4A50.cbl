      *=================================================================
      *@업무명    : KIP     (기업집단신용평가)
      *@프로그램명: AIP4A50 (AS기업집단신용평가현황조회)
      *@처리유형  : AS
      *@처리개요  : 기업집단신용평가현황조회하는 프로그램이다
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIP4A50'.
      ...
      *@3 처리DC호출: 기업집단 합산연결/합산 재무제표 구성조회
           PERFORM S3100-PROC-DIPA501-RTN
              THRU S3100-PROC-DIPA501-EXT
      ...
      *@처리내용 : 처리DC입력파라미터 = AS입력파라미터
           ...
           MOVE  YNIP4A50-CA    TO  XDIPA501-IN
      ...
      *@처리내용 : 출력파라미터 = SET(DC출력파라미터)
           ...
           MOVE  XDIPA501-OUT     TO  YPIP4A50-CA

      *@8 종료처리
           .
       S3100-PROC-DIPA501-EXT.
           EXIT.
