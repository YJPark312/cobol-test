      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIPBA51'.
      ...
      *@3 처리DC호출: 합산연결 재무제표 구성 등록
           PERFORM S3100-PROC-DIPA511-RTN
              THRU S3100-PROC-DIPA511-EXT
      ...
      *@처리내용 : 처리DC입력파라미터 = AS입력파라미터
           ...
           MOVE  YNIPBA51-CA    TO  XDIPA511-IN
      ...
      *@처리내용 : 출력파라미터 = SET(DC출력파라미터)
           ...
           MOVE  XDIPA511-OUT     TO  YPIPBA51-CA
