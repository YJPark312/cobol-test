      *=================================================================
      *@업무명    : KIP     (기업집단신용평가)
      *@프로그램명: AIPBA71 (AS기업집단신용등급산출)
      *@처리유형  : AS
      *@처리개요  : 기업집단신용등급산출등록하는 프로그램이다
      *-----------------------------------------------------------------
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'AIPBA71'.
      ...
      *@3 처리DC호출: 재무평점일괄산출등록
           PERFORM S3100-PROC-DIPA711-RTN
              THRU S3100-PROC-DIPA711-EXT
      ...
      *@처리내용 : 처리DC입력파라미터 = AS입력파라미터
           ...
           MOVE  YNIPBA71-CA    TO  XDIPA711-IN
      ...
      *@처리내용 : 출력파라미터 = SET(DC출력파라미터)
           ...
           MOVE  XDIPA711-OUT     TO  YPIPBA71-CA
