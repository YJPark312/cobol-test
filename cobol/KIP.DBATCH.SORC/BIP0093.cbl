      ...
      *=================================================================
      *@업무명    : KIP (기업집단 신용평가)
      *@프로그램명: BIP0093 (기업집단 합산연결재무비율 생성)
      *@처리유형  : BATCH
      ...
      *-----------------------------------------------------------------
       01  CO-AREA.
           03  CO-PGM-ID               PIC  X(008) VALUE 'BIP0093'.
...
161108*@  재무분석자료번호(구분+고객식별자)
      ...
      *#1 SQLIO 호출결과 확인
           ...
           WHEN ZEROS
                ...
                DISPLAY "※ C131 기존 데이터 삭제 ※"
                DISPLAY "기업집단그룹코드 ["
                               WK-DB-CORP-CLCT-GROUP-CD "]"
                DISPLAY "기업집단등록코드 ["
                               WK-DB-CORP-CLCT-REGI-CD "]"
                DISPLAY "기준년 [" WK-DEL-BASE-YR "]"
