...
230413*김경호:20230413:P20232241714-관계기업정보 일일변경시
      ...
      *    기업규모구분
           03  WK-CRS-CRDT-VC-SCAL-DSTCD PIC  X(001).
      *    CRS 처리결과
...
170207     OR  WK-A110-CUNIQNO-DSTCD = '16'
      ...
      *    신용평가기업규모구분
           MOVE ' '  TO WK-CRS-CRDT-VC-SCAL-DSTCD
           MOVE ' '  TO WK-CRS-DESC
      ...
      *    초기화
           MOVE '0' TO WK-CRS-CRDT-VC-SCAL-DSTCD

      *    신용평가기업규모구분

           IF XIIIK083-O-CRDT-VC-SCAL-DSTCD = '01'
               MOVE '2' TO WK-CRS-CRDT-VC-SCAL-DSTCD
           END-IF
           IF XIIIK083-O-CRDT-VC-SCAL-DSTCD = '02'
               MOVE '7' TO WK-CRS-CRDT-VC-SCAL-DSTCD
           END-IF
           ...
           IF XIIIK083-O-CRDT-VC-SCAL-DSTCD = '11'
               MOVE '1' TO WK-CRS-CRDT-VC-SCAL-DSTCD
           END-IF
...
230413*    대표업체명이 있을 경우
      ...
      *    기업규모구분
           MOVE WK-CRS-CRDT-VC-SCAL-DSTCD
