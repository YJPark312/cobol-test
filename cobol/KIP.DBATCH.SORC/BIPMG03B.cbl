      ...
      *           평가요령내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O1-VALUA-RULE-CTNT TO  WK-T-DATA1
                   MOVE  WK-O1-VALUA-RULE-CTNT TO  WK-T-DATA2
      ...
      *           평가가이드최상내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O1-VALUA-GM-UPER-CTNT TO  WK-T-DATA1
                   MOVE  WK-O1-VALUA-GM-UPER-CTNT TO  WK-T-DATA2
      ...
      *           평가가이드상내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O1-VALUA-GD-UPER-CTNT TO  WK-T-DATA1
                   MOVE  WK-O1-VALUA-GD-UPER-CTNT TO  WK-T-DATA2
                   MOVE  CO-NUM-1000              TO  WK-T-LENGTH
      *@           EBCDIC -> ASCII->EBCDIC 로변환　모듈　호출
                   PERFORM S8100-ZUGCDCV-CALL-RTN
                      THRU S8100-ZUGCDCV-CALL-EXT
      ...
      *           평가가이드중내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O1-VALUA-GD-MIDL-CTNT TO  WK-T-DATA1
                   MOVE  WK-O1-VALUA-GD-MIDL-CTNT TO  WK-T-DATA2
                   MOVE  CO-NUM-1000              TO  WK-T-LENGTH
      *@           EBCDIC -> ASCII->EBCDIC 로변환　모듈　호출
                   PERFORM S8100-ZUGCDCV-CALL-RTN
                      THRU S8100-ZUGCDCV-CALL-EXT
      ...
      *           평가가이드하내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O1-VALUA-GD-LOWR-CTNT TO  WK-T-DATA1
                   MOVE  WK-O1-VALUA-GD-LOWR-CTNT TO  WK-T-DATA2
                   MOVE  CO-NUM-1000              TO  WK-T-LENGTH
      *@           EBCDIC -> ASCII->EBCDIC 로변환　모듈　호출
                   PERFORM S8100-ZUGCDCV-CALL-RTN
                      THRU S8100-ZUGCDCV-CALL-EXT
      ...
      *           평가가이드최하내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O1-VALUA-GD-LWST-CTNT TO  WK-T-DATA1
                   MOVE  WK-O1-VALUA-GD-LWST-CTNT TO  WK-T-DATA2
                   MOVE  CO-NUM-1000              TO  WK-T-LENGTH
      *@           EBCDIC -> ASCII->EBCDIC 로변환　모듈　호출
                   PERFORM S8100-ZUGCDCV-CALL-RTN
                      THRU S8100-ZUGCDCV-CALL-EXT
      ...
      *           승인의견내용 EBCDIC -> ASCII -> EBCDIC
                   MOVE  WK-O2-ATHOR-OPIN-CTNT TO  WK-T-DATA1
                   MOVE  WK-ATHOR-OPIN-CTNT    TO  WK-T-DATA2
