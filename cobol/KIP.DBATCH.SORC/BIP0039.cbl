      ...
      *@  기준년항목금액
           03  WK-B113-BASE-YR-ITEM-AMT    PIC S9(015).
      *@  기준년비율
       ...
       S6810-CHGLOG-WRITEB118-RTN.
           ...
           EVALUATE SQLCODE
               WHEN ZERO
                    ...
                    INITIALIZE LOG-REC-B118

                    MOVE SPACE TO WK-DB-GRD-ADJS-DSTCD

      *@           그룹회사코드
                    MOVE  WK-DB-GROUP-CO-CD
                      TO  WK-B118-GROUP-CO-CD
      *@           기업집단그룹코드
                    MOVE  WK-DB-CORP-CLCT-GROUP-CD
                      TO  WK-B118-CORP-CLCT-GROUP-CD
      *@           기업집단등록코드
                    MOVE  WK-DB-CORP-CLCT-REGI-CD
                      TO  WK-B118-CORP-CLCT-REGI-CD
      *@           평가년월일
                    MOVE  WK-DB-VALUA-YMD
                      TO  WK-B118-VALUA-YMD
      *@           등급조정구분
                    MOVE  WK-DB-GRD-ADJS-DSTCD
                      TO  WK-B118-GRD-ADJS-DSTCD
      *@           등급조정사유내용
                    MOVE  WK-DB-GRD-ADJS-RESN-CTNT
                      TO  WK-B118-GRD-ADJS-RESN-CTNT
      *@           시스템최종처리일시
                    MOVE  WK-DB-SYS-LAST-PRCSS-YMS
                      TO  WK-B118-SYS-LAST-PRCSS-YMS
      *@           시스템최종사용자번호
                    MOVE  WK-DB-SYS-LAST-UNO
                      TO  WK-B118-SYS-LAST-UNO
      ...
      *#1           LOG파일상태가 정상이 아닐경우
                    IF  WK-LOG-FILE-ST7 NOT = '00'
                    THEN
                        DISPLAY '#CHGFILE WRITE ERROR ' WK-LOG-FILE-ST7
      *@1              처리종료
                        PERFORM S9000-FINAL-RTN
                           THRU S9000-FINAL-EXT
                    END-IF

                    ADD 1 TO WK-CHGLOG-WRITEB118
       ...
       S6910-CHGLOG-WRITEB130-RTN.
           ...
           EVALUATE SQLCODE
               WHEN ZERO
                    ...
                    INITIALIZE LOG-REC-B130

      *@           그룹회사코드
                    MOVE  WK-DB-GROUP-CO-CD
                      TO  WK-B130-GROUP-CO-CD
      *@           기업집단그룹코드
                    MOVE  WK-DB-CORP-CLCT-GROUP-CD
                      TO  WK-B130-CORP-CLCT-GROUP-CD
      *@           기업집단등록코드
                    MOVE  WK-DB-CORP-CLCT-REGI-CD
                      TO  WK-B130-CORP-CLCT-REGI-CD
      *@           평가년월일
                    MOVE  WK-DB-VALUA-YMD
                      TO  WK-B130-VALUA-YMD
      *@           기업집단주석구분
                    MOVE  WK-DB-CORP-C-COMT-DSTCD
                      TO  WK-B130-CORP-C-COMT-DSTCD
      *@           일련번호
                    MOVE  WK-DB-SERNO
                      TO  WK-B130-SERNO
      *@           주석내용
                    MOVE  WK-DB-COMT-CTNT
                      TO  WK-B130-COMT-CTNT
      *@           시스템최종처리일시
                    MOVE  WK-DB-SYS-LAST-PRCSS-YMS
                      TO  WK-B130-SYS-LAST-PRCSS-YMS
      *@           시스템최종사용자번호
                    MOVE  WK-DB-SYS-LAST-UNO
                      TO  WK-B130-SYS-LAST-UNO
      ...
      *#1           LOG파일상태가 정상이 아닐경우
                    IF  WK-LOG-FILE-ST8 NOT = '00'
                    THEN
                        DISPLAY '#CHGFILE WRITE ERROR ' WK-LOG-FILE-ST8
      *@1              처리종료
                        PERFORM S9000-FINAL-RTN
                           THRU S9000-FINAL-EXT
                    END-IF

                    ADD 1 TO WK-CHGLOG-WRITEB130
      ...
      *-----------------------------------------------------------------
       S9000-DISPLAY-RTN.
           ...
           DISPLAY '+  THKIPB118 WRITE COUNT : ' WK-CHGLOG-WRITEB118
           DISPLAY '+  THKIPB130 WRITE COUNT : ' WK-CHGLOG-WRITEB130
