...
//*---------------------------------------------------------------
//KIPB110  EXEC DSNUPROC,PARM='DAPG,KIPB110',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.B110.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPB112  EXEC DSNUPROC,PARM='DAPG,KIPB112',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.B112.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPB113  EXEC DSNUPROC,PARM='DAPG,KIPB113',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.B113.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPB114  EXEC DSNUPROC,PARM='DAPG,KIPB114',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.B114.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPB116  EXEC DSNUPROC,PARM='DAPG,KIPB116',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.B116.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPB130  EXEC DSNUPROC,PARM='DAPG,KIPB130',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.B130.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPC110  EXEC DSNUPROC,PARM='DAPG,KIPC110',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.C110.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPC120  EXEC DSNUPROC,PARM='DAPG,KIPC120',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.C120.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPC121  EXEC DSNUPROC,PARM='DAPG,KIPC120',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.C121.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
//*---------------------------------------------------------------
//KIPC130  EXEC DSNUPROC,PARM='DAPG,KIPC130',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.C130.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME YES
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM518)
//*---------------------------------------------------------------
//KIPM518  EXEC DSNUPROC,PARM='DAPG,KIPM518',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
//SORTWK02 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
//SORTWK03 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
//SORTWK04 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
//SORTWK05 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
//SYSUT1   DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M518.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM510)
//*---------------------------------------------------------------
//KIPM510  EXEC DSNUPROC,PARM='DAPG,KIPM510',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M510.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM511)
//*---------------------------------------------------------------
//KIPM511  EXEC DSNUPROC,PARM='DAPG,KIPM511',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M511.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM512)
//*---------------------------------------------------------------
//KIPM512  EXEC DSNUPROC,PARM='DAPG,KIPM512',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M512.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM513)
//*---------------------------------------------------------------
//KIPM513  EXEC DSNUPROC,PARM='DAPG,KIPM513',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M513.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM514)
//*---------------------------------------------------------------
//KIPM514  EXEC DSNUPROC,PARM='DAPG,KIPM514',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M514.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM515)
//*---------------------------------------------------------------
//KIPM515  EXEC DSNUPROC,PARM='DAPG,KIPM515',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M515.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM516)
//*---------------------------------------------------------------
//KIPM516  EXEC DSNUPROC,PARM='DAPG,KIPM516',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M516.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
/*
//*---------------------------------------------------------------
//* STEP_01:TABLE 초기값LOAD (THKIPM517)
//*---------------------------------------------------------------
//KIPM517  EXEC DSNUPROC,PARM='DAPG,KIPM517',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(500,500),RLSE)
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(100,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.M517.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
