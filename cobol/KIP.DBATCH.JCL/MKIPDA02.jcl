//MKIPDA02 JOB NOTIFY=&SYSUID,CLASS=B,MSGCLASS=X
//*----------------------------------------------
//*관계기업별 여신현황 반영(영업일작업)
...
//SYSIN    DD *
  ...
  DELETE   KIP.SM.CHGLOG.MKIPDA02.CC%%ODATE
  SET MAXCC=00
/*
//*-----------------------------------------
//*STEP2 :관계기업군 현황갱신
...
//SYSOUT   DD SYSOUT=*
//OUTFILE1 DD DSN=KIP.SD.SHRKIP.BIP0002.OUT,
//            DISP=(NEW,CATLG,DELETE),
//            UNIT=SYSDA,SPACE=(CYL,(100,100),RLSE),
//            DCB=(RECFM=FB,LRECL=100,BLKSIZE=27900)
//CHGLOG   DD DSN=KIP.SM.CHGLOG.MKIPDA02.CC%%ODATE,
//            DISP=(NEW,CATLG,DELETE),
