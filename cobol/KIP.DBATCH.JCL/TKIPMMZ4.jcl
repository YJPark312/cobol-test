//TKIPMMZ4 JOB CLASS=T,MSGCLASS=X
//*******************************************************************
//*@ 업무명     : KIP (기업집단신용평가) *
...
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM510.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM511.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM512.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM513.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM514.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM515.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM516.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM517.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(10,10),RLSE)
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.SY.KIPM518.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
