//MKIPDA29 JOB NOTIFY=&SYSUID,CLASS=B,MSGCLASS=X
//*--------*-----------------------------------------------------------
//* 기업집단평가 합산연결현금수지 생성                         *
//* 선행 : MKIPDA28                                                *
//* 후행 : MKIPDA30                                                *
...
//SYSPRINT DD SYSOUT=*
//SYSIN    DD *
  DELETE   KIP.ST.CHGLOG.MKIPDA29.CC%%ODATE
     SET   MAXCC = 00
/*
//*--------*-----------------------------------------------------------
...
//SYSOUT   DD SYSOUT=*
//CHGLOG   DD DSN=KIP.ST.CHGLOG.MKIPDA29.CC%%ODATE,
//            DISP=(NEW,CATLG,DELETE),
//            DCB=(RECFM=VB,BLKSIZE=32760,LRECL=32756),
//            UNIT=SYSDA,SPACE=(CYL,(1000,1000),RLSE)
//SYSIN    DD *
KB0-%%$ODATE-001-001-NORBAT-BIP0029-MKIPDA29
/*
