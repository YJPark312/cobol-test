//TKIPCB35 JOB NOTIFY=&SYSUID,CLASS=A,MSGCLASS=X
//*******************************************************************
//*@ 업무명     : KIP (기업집단신용평가)                 *
...
//* LOAD DATA : THKIPC120 *
//*******************************************************************
//TKIPC120  EXEC DSNUPROC,PARM='DATG,KIPC120',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
...
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.DT.TKIPC120.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
...
//* LOAD DATA : THKIPC121 *
//*******************************************************************
//TKIPC121  EXEC DSNUPROC,PARM='DATG,KIPC121',COND=(4,LT)
//DSNTRACE DD  SYSOUT=*
//SORTLIB  DD  DSN=SYS1.SORTLIB,DISP=SHR
//DFSPARM  DD  DSN=SYS1.PARMLIB(DFSPARMH),DISP=SHR
//SORTWK01 DD  UNIT=SYSDA,SPACE=(CYL,(3000,300),RLSE),DSNTYPE=LARGE
...
//SORTOUT  DD  UNIT=SYSDA,SPACE=(CYL,(3000,300),RLSE),DSNTYPE=LARGE
//SYSPRINT DD  SYSOUT=*
//SYSREC01 DD  DSN=KIP.DT.TKIPC121.UNLOAD,DISP=SHR
//SYSIN    DD *
  LOAD DATA LOG NO
  NOCOPYPEND
  RESUME NO REPLACE
