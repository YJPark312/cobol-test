        ...
        new Thread(() -> {
            ...
            for (GeneratedFile gf : files) {
                try {
                    ...
                    // AIPBA30/source/com/example/AIPBA30PU.java → generated/AIPBA30/source/...
                    // AIPBA30/output/analysis_spec.md → generated/AIPBA30/output/...
                    String relativePath = "generated/" + gf.path;
                    ...
                    if (gf.path.contains("conversion_log.md")) {
                        fileToOpen = iFile;
