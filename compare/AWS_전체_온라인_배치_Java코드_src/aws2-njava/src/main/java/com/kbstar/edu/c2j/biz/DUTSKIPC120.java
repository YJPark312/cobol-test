...
/**
 * 기업집단합산연결재무제표정보 테이블DU.
 * <pre>
 * 유닛 설명 : TSKIPC120 테이블 데이터 접근
 * ---------------------------------------------------------------------------------
 *  버전    일자            작성자            설명
 * ---------------------------------------------------------------------------------
 ...
 * @since 2025-10-02
 */
@BizUnit(value = "기업집단합산연결재무제표정보 테이블DU", type = "DU")
public class DUTSKIPC120 extends com.kbstar.sqc.base.DataUnit {

    /**
     * 기업집단합산연결재무제표정보 테이블 SELECT.
     * <pre>
     * 기업집단합산연결재무제표정보조회
     * </pre>
     ...
     *    - field : stdrYm [기준년월] (string)
     *    - field : fnafStmtDstcd [재무제표구분코드] (string) - optional
     * </pre>
     * @param onlineCtx 요청 컨텍스트 정보
     * @return 처리결과 DataSet 객체
     * <pre>
     *    - recordSet : LIST [기업집단합산연결재무제표정보 LIST]
     *        - field : groupCoCd [그룹회사코드] (string)
     *        - field : corpClctGroupCd [기업집단그룹코드] (string)
     *        - field : stdrYm [기준년월] (string)
     ...
     *        - field : fnafStmtAmt [재무제표금액] (decimal)
     * </pre>
     * 
     * @author MultiQ4KBBank
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산연결재무제표정보 테이블 SELECT")
    ...
    /**
     * 기업집단합산연결재무제표정보 테이블 INSERT.
     * <pre>
     * 신규 기업집단합산연결재무제표정보 레코드 생성
     * </pre>
     * @param requestData 요청정보 DataSet 객체
     * <pre>
     *    - field : groupCoCd [그룹회사코드] (string)
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산연결재무제표정보 테이블 INSERT")
    ...
    /**
     * 기업집단합산연결재무제표정보 테이블 UPDATE.
     * <pre>
     * 기업집단합산연결재무제표정보 레코드 수정
     * </pre>
     * @param requestData 요청정보 DataSet 객체
     * <pre>
     *    - field : groupCoCd [그룹회사코드] (string)
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산연결재무제표정보 테이블 UPDATE")
