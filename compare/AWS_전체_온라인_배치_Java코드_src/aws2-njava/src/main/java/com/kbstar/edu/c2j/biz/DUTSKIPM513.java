...
/**
 * 기업집단재무평가모형산식목록 테이블DU.
 * <pre>
 * 유닛 설명 : TSKIPM513 테이블 데이터 접근
 * ---------------------------------------------------------------------------------
 *  버전    일자            작성자            설명
 * ---------------------------------------------------------------------------------
 ...
 * @since 2025-10-02
 */
@BizUnit(value = "기업집단재무평가모형산식목록 테이블DU", type = "DU")
public class DUTSKIPM513 extends com.kbstar.sqc.base.DataUnit {

    /**
     * 기업집단재무평가모형산식목록 테이블 SELECT.
     * <pre>
     * 기업집단재무평가모형산식목록 조회
     * </pre>
     ...
     *    - field : mdlFormulaCd [모형산식코드] (string)
     * </pre>
     * @param onlineCtx 요청 컨텍스트 정보
     * @return 처리결과 DataSet 객체
     * <pre>
     *    - recordSet : LIST [기업집단재무평가모형산식목록 LIST]
     * </pre>
     * 
     * @author MultiQ4KBBank
     * @since 2025-10-02
     */
    @BizMethod("기업집단재무평가모형산식목록 테이블 SELECT")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단재무평가모형산식목록 테이블 INSERT")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단재무평가모형산식목록 테이블 UPDATE")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단재무평가모형산식목록 테이블 DELETE")
