 ...
 * @since 2025-10-02
 */
@BizUnit(value = "기업집단합산재무비율 테이블DU", type = "DU")
public class DUTSKIPC121 extends com.kbstar.sqc.base.DataUnit {

    /**
     * 기업집단합산재무비율 테이블 SELECT.
     * <pre>
     * 기업집단합산재무비율 레코드 조회
     * </pre>
     ...
     *    - field : fnafYmd [재무년월일] (string)
     * </pre>
     * @param onlineCtx 요청 컨텍스트 정보
     * @return 처리결과 DataSet 객체
     * <pre>
     *    - recordSet : RECORD [기업집단합산재무비율 레코드]
     * </pre>
     * 
     * @author MultiQ4KBBank
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산재무비율 테이블 SELECT")
     ...
     *    - field : fnafYmd [재무년월일] (string) - optional
     * </pre>
     * @param onlineCtx 요청 컨텍스트 정보
     * @return 처리결과 DataSet 객체
     * <pre>
     *    - recordSet : LIST [기업집단합산재무비율 테이블 LIST]
     *        - field : groupCoCd [그룹회사코드] (string)
     *        - field : corpClctGroupCd [기업집단그룹코드] (string)
     *        - field : corpClctRegiCd [기업집단등록코드] (string)
     *        - field : fnafYmd [재무년월일] (string)
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산재무비율 테이블 SELECT LIST")
    ...
    /**
     * 기업집단합산재무비율 테이블 INSERT.
     * <pre>
     * 신규 기업집단합산재무비율 레코드 생성
     * </pre>
     * @param requestData 요청정보 DataSet 객체
     * <pre>
     *    - field : groupCoCd [그룹회사코드] (string)
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산재무비율 테이블 INSERT")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단합산재무비율 테이블 UPDATE")
