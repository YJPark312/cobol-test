 ...
 * @since 2025-10-02
 */
@BizUnit(value = "기업집단연결대상재무제표 테이블DU", type = "DU")
public class DUTSKIPC140 extends com.kbstar.sqc.base.DataUnit {

    /**
     * 기업집단연결대상재무제표 테이블 SELECT.
     * <pre>
     * 기업집단연결대상재무제표 조회
     * </pre>
     ...
     * <pre>
     *    - recordSet : LIST [기업집단연결대상재무제표 LIST]
     * </pre>
     * 
     * @author MultiQ4KBBank
     * @since 2025-10-02
     */
    @BizMethod("기업집단연결대상재무제표 테이블 SELECT")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단연결대상재무제표 테이블 INSERT")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단연결대상재무제표 테이블 UPDATE")
     ...
     * @since 2025-10-02
     */
    @BizMethod("기업집단연결대상재무제표 테이블 DELETE")
